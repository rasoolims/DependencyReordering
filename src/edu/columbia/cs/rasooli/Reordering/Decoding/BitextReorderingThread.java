...
public class BitextReorderingThread implements Callable<Pair<String,Integer>> {
    ...
    public BitextReorderingThread(final int treeNumber, BitextDependency bitextDependency,final Reorderer reorderer) {
    ...
    public Pair<String, Integer> call() throws Exception {
        return new Pair<String, Integer>(reorderer.reorderWithAlignmentGuide(bitextDependency).toConllOutput(),treeNumber);
    }
}
